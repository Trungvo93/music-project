...
const Header = () => {
  ...
  return (
    <div className='relative w-full ' id='searchBar'>
      <div
        className={`flex p-5 topBar justify-between content-center fixed   z-50 left-[${positionLeft}px]`}
        style={{ width: widthHeader + "px" }}>
        {/* Searchbar */}
        <label className='relative block flex-initial w-1/2 ' ref={wrapperRef}>
